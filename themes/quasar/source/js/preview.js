      ...
      $this.after(
        ...
        mobileThemes.map(function(theme) {
          return '<a class="spawn-demo" ' +
            'href="/preview/' + theme + '.html#/' + page +
            '" target="_blank"><i class="fa fa-' + theme + '"></i></a>';
        }).join(' ') +
        ' <a class="spawn-demo" target="_blank" ' +
        'href="https://github.com/rstoenescu/quasar-site/tree/master/preview/pages/' + page +
