...
---
You will notice in the project structure we have two directories for assets: `/src/statics/` and `/src/assets/`. What is the difference between them? Some are static assets while the other are processed and embedded by the build system.

## Type of Assets

So let's try to answer the question above. We first discuss about using the regular assets then we'll see what static assets means.
