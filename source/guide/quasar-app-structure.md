...
Placing files in these folder ensures that the Build System will compile them accordingly.
...
| view.**&lt;page-name&gt;**.html | Template for your page |
...
| Asset | Description |
| --- | --- |
| /src/layouts/**&lt;layout-name&gt;** | Layout folder |
